...
const { xeontext7 } = require('./src/data/function/XBug/xeontext7')
const { xeontext8 } = require('./src/data/function/XBug/xeontext8')
const { xeontext9 } = require('./src/data/function/XBug/xeontext9')
const { xeontext10 } = require('./src/data/function/XBug/xeontext10')
const { xeontext11 } = require('./src/data/function/XBug/xeontext11')
const wkwk = fs.readFileSync(`./src/data/function/XBug/x.mp3`)
const xsteek = fs.readFileSync(`./src/data/function/XBug/x.webp`)
const o = fs.readFileSync('./src/data/function/XBug/o.jpg')
...
"header": {
"hasMediaAttachment": true,
"jpegThumbnail": fs.readFileSync(`./src/data/function/XBug/xx1.png`)
},
"nativeFlowMessage": {
"buttons": [
{
...
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  async function xeonBugPay(jid){
    ...
    [whatsappNumber]
				...
				break;
		case 'xfreeze': case 'onekill': case 'oneclickall': case 'xsamsung': case 'xwaweb': case 'doublekill': case '💀': case 'triplekill': {
if (!isPremium) return replygcxeon(mess.prem)
